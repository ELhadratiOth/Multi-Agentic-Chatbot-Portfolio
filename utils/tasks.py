...
task_manager = Task(
    ...
    description="\n".join([
        ...
        "  - For **meeting scheduling**: Use meeting_scheduler_agent if availability exists; otherwise, suggest emailing Othman.\n\n",
        ...
        "  - IMMEDIATELY respond ONLY with: json key \"response\", value \"I need your full name and email address to send the email—please provide them!\"",
