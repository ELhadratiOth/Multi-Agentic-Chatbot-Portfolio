...
general_agent = Agent(
    ...
    backstory=(
        ...
        "**CRITICAL Output Formatting**: When you retrieve information that contains emails or links in backticks format (e.g., `othmanelhadrati@gmail.com`, `https://www.0thman.tech`), "
        "you must transform them into proper markdown links format: [descriptive text](url) or [email text](mailto:email). Remove the backticks and create meaningful link text. "
...
all_repos_agent = Agent(
    ...
    backstory=(
        ...
        "**CRITICAL Output Formatting**: Transform any backticked links into proper markdown format: [descriptive text](url). "
...
agent_manager = Agent(
    ...
    backstory=" ".join([
        ...
        "- **Home page** (/) where you can grab his resume\n",
        "- **About page** (/about) with his professional journey\n",
        "- **Projects section** (/projects) showcasing his work\n",
        "- **Contact page** (/contactme) for getting in touch\n",
        "- **Services page** (/services) explaining his expertise\n\n",
        ...
        "- Transform backticked links to markdown format: [descriptive text](url)\n",
        "- Be warm, welcoming, and professional\n",
        "- Format portfolio routes as clickable links for easy navigation\n",
